  ...
  function getDataType(dataset) {
    ...
    for (var _i = 0; _i < dataset.length; _i++) {
      ...
      for (var key in dataElement) {
        data += dataElement[key].appartenance.ms.age.moins5ans + dataElement[key].appartenance.ms.age.plus5ans + dataElement[key].appartenance.commune.age.moins5ans + dataElement[key].appartenance.commune.age.moins5ans + dataElement[key].appartenance.ong.age.plus5ans + dataElement[key].appartenance.ong.age.plus5ans;
      }
    }
