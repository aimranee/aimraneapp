...
$(document).ready(function () {
  ...
  var planAction = $('#data').data('provincedata').planAction,
      ...
      data = _defineProperty({}, codeProvince, $('#data').data('provincedata').tauxRemplissage),
      title = $('#title').text(),
      year,
      // other
  ...
  $('#province-map').vectorMap({
    ...
    series: {
      regions: [{
        values: _defineProperty({}, codeProvince, data[codeProvince]),
        scale: scale,
