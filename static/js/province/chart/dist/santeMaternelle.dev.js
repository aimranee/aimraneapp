...
$(document).ready(function () {
  ...
  var wholeData = $('#data').data('provincedata'),
      ...
      // init data
  // DATA LOADING
  data = getData([wholeData.femmePriseCharge], csrList); // CHART OPTION
  ...
  $('input[type=radio][name=data]').change(function () {
    ...
    if (this.value === 'femmePriseCharge') {
      ...
      data = getData([wholeData.cpnNouvelleInscriteT1, wholeData.cpnNouvelleInscriteT2, wholeData.cpnNouvelleInscriteT3, wholeData.cpnAncienneInscriteT1, wholeData.cpnAncienneInscriteT2, wholeData.cpnAncienneInscriteT3], csrList);
