...
$(document).ready(function () {
  ...
  var wholeData = $('#data').data('provincedata'),
      ...
      // init data
  // DATA LOADING
  data = getData([wholeData.populationCible], csrList); // CHART OPTION
  ...
  $('input[type=radio][name=data]').change(function () {
    ...
    if (this.value === 'populationCible') {
      ...
      data = getData([wholeData.enfantNaissancesAttendues, wholeData.enfantMoins1ans, wholeData.enfantMoins5ans], csrList);
    } else if (this.value === 'femme') {
      data = getData([wholeData.femmeFar, wholeData.femmeFmar, wholeData.femmeFemmeEnceinte], csrList);
    } // apply changes
