...
$(document).ready(function () {
  ...
  var wholeData = $('#data').data('provincedata'),
      ...
      // init data
  // DATA LOADING
  data = getData([wholeData.femmeExamineCancerSein, wholeData.femmeExamineCancerCol], csrList),
  ...
  $('input[type=radio][name=data]').change(function () {
    ...
    if (this.value === 'femmeExamine') {
      ...
      data = getData([wholeData.femmeRefereCancerSein, wholeData.femmeRefereCancerCol], csrList);
      table = 2.1;
    } // apply changes
