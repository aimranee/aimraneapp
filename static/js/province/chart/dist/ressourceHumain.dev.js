...
$(document).ready(function () {
  ...
  var wholeData = $('#data').data('provincedata'),
      ...
      // init data
  // DATA LOADING
  data = getData([wholeData.fixeMedecin, wholeData.fixeInfirmier, wholeData.fixeSageFemme, wholeData.fixeTechnicien, wholeData.fixeChauffeur, wholeData.fixeAppuie], csrList); // CHART OPTION
  ...
  $('input[type=radio][name=data]').change(function () {
    ...
    if (this.value === 'fixe') {
      data = getData([wholeData.fixeMedecin, wholeData.fixeInfirmier, wholeData.fixeSageFemme, wholeData.fixeTechnicien, wholeData.fixeChauffeur, wholeData.fixeAppuie], csrList);
    } else if (this.value === 'mobile') {
      data = getData([wholeData.mobileMedecin, wholeData.mobileInfirmier, wholeData.mobileSageFemme, wholeData.mobileTechnicien, wholeData.mobileChauffeur, wholeData.mobileAppuie], csrList);
