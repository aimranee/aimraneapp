...
$(document).ready(function () {
  ...
  function pdf() {
    ...
    function generateMulPdf(region, province, year) {
      ...
      doc.save("plan d'action des unités médicales mobiles (umm) - " + province + ' - ' + year + '.pdf');
    } // call the function
    ...
    $('#downloadPlanActionAllPdf').click(function () {
      ...
      generateMulPdf($(this).data('region'), $(this).data('province'), today.getFullYear());
    });
  }
