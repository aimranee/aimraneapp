...
$(document).ready(function () {
  ...
  function pdf() {
    ...
    function generateMulPdf(region, province, year) {
      ...
      doc.save("plan d'action des unités médicales mobiles (umm) - " + region + ' - ' + year + '.pdf');
    } // call the function
    ...
    $('#downloadPlanActionAllPdf').click(function () {
      ...
      generateMulPdf($(this).data('region'), $('#data').data('province'), today.getFullYear());
    });
  }
